...
import { PinIcon } from "evergreen-ui";
        ...
        <span contentEditable={false}>
...

          {
            ...
            props.editor.isEditable ? (
              <a href="#" className={"graf--media-embed-close"} onClick={deleteSelf}>
                x
              </a>
            ) : null
          }
          ...
          <span contentEditable={false}>{embed_data.provider_url || embed_data.url}</span>
        </span>
      </NodeViewContent>
    </StyleWrapper>
  );
